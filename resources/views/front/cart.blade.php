                    ...
                    <div class="cart-summary">
                        ...
                        @if (env('Environment') == 'sendbox')
                            ...
                            <div class="promo-wrap open">
                                <input type="text" placeholder="Enter a location" name="address" size="50" id="address" value="Delhi, DEL, IND" required="" readonly="" autocomplete="on" > 
                                <input type="hidden" id="lat" name="lat" value="28.731045" />
                                <input type="hidden" id="lang" name="lang" value="77.249283" />
                                <input type="hidden" id="city" name="city" placeholder="city" value="Delhi" /> 
                                <input type="hidden" id="state" name="state" placeholder="state" value="DEL" /> 
                                <input type="hidden" id="country" name="country" placeholder="country" value="IND" />
                            </div>
