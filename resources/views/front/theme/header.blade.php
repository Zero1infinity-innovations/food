...
<head>
	...
	<meta property="og:title" content="restaurant food ordering Website " />

	<meta property="og:description" content="Restaurant food ordering Website is a catalyst for the food industry." />
	...
	<header>
		...
		<nav class="navbar navbar-expand-lg">
			...
			<div class="container">
				...
				<a href="{{URL::to('/product')}}"><img src='https://savvicrm.com/food/11.png' alt="" style="width: 120px; border-radius: 10px;"></a>
